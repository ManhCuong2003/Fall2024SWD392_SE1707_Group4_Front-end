...
import { FaKiwiBird, FaEnvelope, FaPhone, FaHome } from "react-icons/fa";
...
const ConsignmentContentPage = () => {
    ...
    const validateField = (name, value) => {
        ...
        switch (name) {
            case "consignmentType":
                if (!value) newErrors.consignmentType = "Please select a consignment type";
            ...
            case "customerEmail":
                ...
                else if (!/\S+@\S+\.\S+/.test(value)) newErrors.customerEmail = "Invalid email format";
                else delete newErrors.customerEmail;
                break;
            case "customerPhone":
                if (!value) newErrors.customerPhone = "Phone number is required";
                else if (!/^\d{10}$/.test(value)) newErrors.customerPhone = "Invalid phone number format";
    ...
    const handleSubmit = (e) => {
        ...
        Object.keys(formData).forEach((key) => {
            ...
            if (!formData[key]) formErrors[key] = `${key.replace(/([A-Z])/g, " $1").toLowerCase()} is required`;
        });
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-100 to-blue-300 py-12 px-4 sm:px-6 lg:px-8 pt-20">
            <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-xl overflow-hidden">
                <div className="px-4 py-5 sm:p-6">
                    <h2 className="text-2xl font-bold text-gray-900 mb-6">Ký gửi cá Koi</h2>
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-4 sm:flex sm:space-x-4 sm:space-y-0">
                            <div className="flex-1">
                                <label htmlFor="consignmentType" className="block text-sm font-medium text-gray-700">
                                    Loại ký gửi
                                </label>
                                <select
                                    id="consignmentType"
                                    ...
                                    aria-describedby={errors.consignmentType ? "consignmentType-error" : undefined}
                                >
                                ...
                                {errors.consignmentType && (
                                    <p className="mt-2 text-sm text-red-600" id="consignmentType-error">
                                        {errors.consignmentType}
                                    </p>
                                )}
                            </div>
                            <div className="flex-1">
                                <label htmlFor="fishName" className="block text-sm font-medium text-gray-700">
                                    Tên cá
                                </label>
                                <div className="mt-1 relative rounded-md shadow-sm">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <FaKiwiBird className="h-5 w-5 text-gray-400" aria-hidden="true" />
                                    </div>
                                    <input
                                        type="text"
                                        name="fishName"
                                        ...
                                        aria-describedby={errors.fishName ? "fishName-error" : undefined}
                                    />
                                </div>
                                {errors.fishName && (
                        ...
                        <div className="space-y-4 sm:flex sm:space-x-4 sm:space-y-0">
                            <div className="flex-1">
                                <label htmlFor="fishSize" className="block text-sm font-medium text-gray-700">
                                    Kích thước
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="flex-1">
                                <label htmlFor="fishBreed" className="block text-sm font-medium text-gray-700">
                                    Giống cá
                                </label>
                                <input
                                    type="text"
                        ...
                        <div className="space-y-4 sm:flex sm:space-x-4 sm:space-y-0">
                            <div className="flex-1">
                                <label htmlFor="fishColor" className="block text-sm font-medium text-gray-700">
                                    Màu sắc
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="flex-1">
                                <label htmlFor="fishMarkings" className="block text-sm font-medium text-gray-700">
